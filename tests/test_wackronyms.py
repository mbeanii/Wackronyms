...
class TestWackronyms:
    ...
    def test_add_response(self):
        self.wackronyms.add_response(self.player1, "testResponse1")
        self.wackronyms.add_response(self.player2, "testResponse2")
    ...
    def test_vote_for_response(self):
        self.wackronyms.vote_for_response("testResponse1")
        assert True